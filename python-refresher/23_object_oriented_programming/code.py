...
student = Student()    # student is the same as the object created in the Student class --> "self". Using "()" is a syntax to relate it to the object
...
print(Student.average_grade(student))    # we are calling the 'average' method from the 'Student' class, using the 'student' object which = Student()
## 88.2

# You can rewrite is this way to make it shorter
